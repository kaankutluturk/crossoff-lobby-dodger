...
- optional automation emits an Escape key-down/key-up pair, waits 400 ms, verifies that Dead by Daylight remains foreground, and then emits an Enter key-down/key-up pair through the standard Windows `SendInput` API.
